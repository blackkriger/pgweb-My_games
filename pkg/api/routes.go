...
func SetupRoutes(router *gin.Engine) {
	...
	api.GET("/query", requireSameOrigin(), RunQuery)
	api.POST("/query", requireSameOrigin(), RunQuery)
	api.GET("/explain", requireSameOrigin(), ExplainQuery)
	api.POST("/explain", requireSameOrigin(), ExplainQuery)
	api.GET("/analyze", requireSameOrigin(), AnalyzeQuery)
	api.POST("/analyze", requireSameOrigin(), AnalyzeQuery)
	api.GET("/history", GetHistory)
	api.GET("/bookmarks", GetBookmarks)
	api.GET("/export", requireSameOrigin(), DataExport)
